...
@inject(PrayerRequestService, NewInstance.of(ValidationController), MessageService, Router, App)
export class PrayerRequestsForm {

    constructor(prayerRequestService, validationController, messageService, router, app) {
